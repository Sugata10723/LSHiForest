...
class MinHashTreeNode(BaseLSHiTreeNode):
    """A node in the MinHash-based isolation tree."""
...
class MinLSHiForest(BaseLSHiForest):
    """MinHash-based LSH Isolation Forest for anomaly detection on categorical data."""
